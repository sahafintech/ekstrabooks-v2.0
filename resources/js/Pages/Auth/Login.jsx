...
const SocialLoginButton = ({ provider, icon: Icon }) => (
...
const LoginForm = ({ onSubmit, data, setData, errors, processing }) => (
...
export default function Login({ status, canResetPassword }) {
    const { data, setData, processing, errors, handleSubmit } = useFormSubmit(
        {
            email: "",
            password: "",
            remember: false,
