...
const DeleteAllPaymentsModal = ({ show, onClose, onConfirm, processing, count }) => (
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to delete {count} selected payment{count !== 1 ? 's' : ''}?
            </h2>
            <div className="mt-6 flex justify-end">
                <Button
                    type="button"
...
export default function List({ subscription_payments = [], meta = {}, filters = {} }) {
    ...
    const toggleSelectAll = () => {
        if (isAllSelected) {
            ...
            setSelectedPayments(subscription_payments.map((payment) => payment.id));
        }
    ...
    const toggleSelectPayment = (id) => {
        if (selectedPayments.includes(id)) {
            ...
            if (selectedPayments.length + 1 === subscription_payments.length) {
    ...
    const handleSearch = (e) => {
        ...
        router.get(
            route("subscription_payments.index"),
    ...
    const handleDelete = (e) => {
        ...
        router.delete(route('subscription_payments.destroy', paymentToDelete), {
            onSuccess: () => {
    ...
    const handleDeleteAll = (e) => {
        ...
        router.post(route('subscription_payments.bulk_destroy'),
            {
                    ...
                    <div className="p-4">
                        ...
                        <div className="rounded-md border">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead className="cursor-pointer" onClick={() => handleSort("user.name")}>
                                            User {renderSortIcon("user.name")}
                                        </TableHead>
                                        <TableHead className="cursor-pointer" onClick={() => handleSort("order_id")}>
                                ...
                                <TableBody>
                                    {subscription_payments.length > 0 ? (
                                                        ...
                                                        actions={[
                                                            {
                                                                ...
                                                                href: route("subscription_payments.show", payment.id),
                                                            },
                                                            {
                                                                label: "Edit",
                                                                icon: <Edit className="h-4 w-4" />,
                                                                href: route("subscription_payments.edit", payment.id),
                                                            },
                                                            {
                                                                label: "Delete",
                        ...
                        {subscription_payments.length > 0 && meta.total > 0 && (
