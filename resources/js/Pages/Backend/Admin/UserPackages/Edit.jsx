...
const submit = (e) => {
	e.preventDefault();
	put(route("user_packages.update", id), {
		preserveScroll: true,
	...
	<AuthenticatedLayout>
		<SidebarInset>
			...
			<form onSubmit={submit} className="p-4 flex flex-col gap-4">
					...
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						...
						>
							<SelectTrigger>
								<SelectValue>
									{data.user_id
										? `${users.find(u => String(u.id) === data.user_id)?.email} - ${
											users.find(u => String(u.id) === data.user_id)?.name
										}`
										: "Select One"}
								</SelectValue>
							</SelectTrigger>
				...
				<div className="grid grid-cols-12 mt-2">
					...
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							...
							onValueChange={(val) => setData("is_popular", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
				...
				<div className="grid grid-cols-12 mt-2">
					...
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							...
							onValueChange={(val) => setData("recurring_invoice", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
				...
				<div className="grid grid-cols-12 mt-2">
					...
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							...
							onValueChange={(val) => setData("deffered_invoice", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
				...
				<div className="grid grid-cols-12 mt-2">
					...
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							...
							onValueChange={(val) => setData("pos", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
									{data.pos === 1 ? "Yes" : "No"}
				...
				<div className="grid grid-cols-12 mt-2">
					...
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							...
							onValueChange={(val) => setData("payroll_module", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
				...
				{/* Medical Record */}
				<div className="grid grid-cols-12 mt-2">
					<Label htmlFor="medical_record" className="md:col-span-2 col-span-12">
						Medical Record
					</Label>
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							value={String(data.medical_record)}
							onValueChange={(val) => setData("medical_record", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
									{data.medical_record === 1 ? "Yes" : "No"}
								</SelectValue>
							</SelectTrigger>
							<SelectContent>
								<SelectItem value="0">No</SelectItem>
						...
						<InputError message={errors.medical_record} className="text-sm" />
					</div>
				</div>

				{/* Prescription */}
				<div className="grid grid-cols-12 mt-2">
					<Label htmlFor="prescription" className="md:col-span-2 col-span-12">
						Prescription
					</Label>
					<div className="md:col-span-10 col-span-12 mt-2 md:mt-0 md:w-1/2 w-full">
						<Select
							value={String(data.prescription)}
							onValueChange={(val) => setData("prescription", parseInt(val))}
						>
							<SelectTrigger>
								<SelectValue>
									{data.prescription === 1 ? "Yes" : "No"}
								</SelectValue>
							</SelectTrigger>
							<SelectContent>
								<SelectItem value="0">No</SelectItem>
