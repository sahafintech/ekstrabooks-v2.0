<x-app-layout>
	...
	<div class="main-content">
		<x-page-header title="Business Type" page="home" subpage="create" />
		<div class="box">
			<div class="box-header">
				<h5>{{ _lang('Create New Business Type') }}</h5>
			</div>
			<div class="box-body">
				<form method="post" class="validate" autocomplete="off" action="{{ route('business_types.store') }}" enctype="multipart/form-data">
					...
					<div class="grid grid-cols-12 mb-4">
						...
						<x-text-input type="text" class="sm:col-span-9 col-span-12" name="name" value="{{ old('name') }}" required />
					</div>

					<div class="grid grid-cols-12 mb-4">
						<x-input-label class="xl:col-span-3 col-span-12" value="{{ _lang('Status') }}" />
						<div class="xl:col-span-9 col-span-12">
							<select class="w-full selectize" name="status" required data-selected="{{ old('status') }}">
