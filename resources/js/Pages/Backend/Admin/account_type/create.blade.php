	...
	<div class="main-content">
		...
		<div class="box">
			<div class="box-header">
				<h5>{{ _lang('Create New Account Type') }}</h5>
			</div>
			<div class="box-body">
				<form method="post" class="validate" autocomplete="off" action="{{ route('account_types.store') }}" enctype="multipart/form-data">
					...
					<div class="grid grid-cols-12 mb-4">
						...
						<x-text-input type="text" class="sm:col-span-9 col-span-12" name="main" value="{{ old('main') }}" required />
					</div>

					<div class="grid grid-cols-12 mb-4">
						<x-input-label class="xl:col-span-3 col-span-12" value="{{ _lang('Types') }}" />
						<x-text-input type="text" class="sm:col-span-9 col-span-12" name="type" value="{{ old('type') }}" required />
					</div>
