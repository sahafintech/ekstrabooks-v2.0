<div id="create-testimonial-modal" class="hs-overlay hidden ti-modal">
	<div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
		<div class="ti-modal-content">
			<div class="ti-modal-header">
				...
				<button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#create-testimonial-modal">
			...
			<form method="post" autocomplete="off" action="{{ route('testimonials.store') }}" enctype="multipart/form-data">
				...
				<div class="ti-modal-body">
					...
					<div class="grid grid-cols-12 gap-x-12 px-2">
						...
						<div class="col-span-12 mt-3">
							...
							<textarea class="w-full" name="trans[testimonial]" required>{{ old('trans.testimonial') }}</textarea>
						</div>

						<div class="col-span-12 mt-3">
							<x-input-label value="{{ _lang('Image') }}" />
							<input type="file" class="fdropify" name="image"/>
						</div>
				...
				<div class="ti-modal-footer">
					<x-secondary-button type="button" data-hs-overlay="#create-testimonial-modal">
						Close
					</x-secondary-button>
