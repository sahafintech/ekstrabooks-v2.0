<div id="edit-feature-modal" class="hs-overlay hidden ti-modal">
	<div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
		<div class="ti-modal-content">
			<div class="ti-modal-header">
				...
				<button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#edit-feature-modal">
					<span class="sr-only">Close</span>
					<i class="ri-close-line text-xl"></i>
				</button>
			</div>
			<form method="post" autocomplete="off" action="{{ route('features.update', 1) }}" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="ti-modal-body">
					<div class="grid grid-cols-12 gap-x-5 px-2">
						...
						<div class="col-span-12 mt-3">
							...
							<x-text-input type="text" class="form-control" name="trans[title]" value="{{ $feature->translation->title }}" required />
						</div>

						<div class="col-span-12 mt-3">
							<x-input-label value="{{ _lang('Description') }}" />
							<textarea class="w-full" name="trans[content]" rows="8" required>{{ $feature->translation->content }}</textarea>
						</div>

						<div class="md:col-span-6 col-span-12 mt-3">
							<x-input-label value="{{ _lang('Status') }}" />
							<select class="w-full" data-selected="{{ $feature->status }}" name="status" required>
				...
				<div class="ti-modal-footer">
					<x-secondary-button type="button" data-hs-overlay="#edit-feature-modal">
						Close
					</x-secondary-button>
