<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ route('brands.update', $id) }}" enctype="multipart/form-data">
	{{ csrf_field() }}
	...
	<div class="ti-modal-body grid grid-cols-12 gap-x-5">
		<div class="col-span-12">
			...
			<x-text-input type="text" name="name" value="{{ $brand->name }}" required />
		</div>
	</div>
