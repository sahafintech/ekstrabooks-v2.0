...
export default function IncomeByCustomer({ report_data, date1, date2, meta = {}, filters = {}, business_name, currency, grand_total, paid_amount, due_amount, customers = [], customer_id = '' }) {
                                        ...
                                        <>
                                            {report_data.map((item) => (
                                                <TableRow key={item.customer_id}>
                                                    ...
                                                    <TableCell className="text-right">{item.grand_total}</TableCell>
                                                    <TableCell className="text-right">{item.paid_amount}</TableCell>
