...
const SummaryCards = ({ bills = [] }) => {
  ...
  const grandTotal = bills.reduce((sum, bill) => sum + parseFloat(bill.grand_total), 0);
  const totalPaid = bills.reduce((sum, bill) => sum + parseFloat(bill.paid), 0);
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="cursor-pointer" onClick={() => handleSort("vendor.name")}>Vendor {renderSortIcon("vendor.name")}</TableHead>
                    <TableHead className="cursor-pointer" onClick={() => handleSort("purchase_date")}>Date {renderSortIcon("purchase_date")}</TableHead>
                    ...
                    <TableHead className="cursor-pointer text-right" onClick={() => handleSort("due")}>Due {renderSortIcon("due")}</TableHead>
                    <TableHead className="cursor-pointer" onClick={() => handleSort("approval_status")}>Approval Status {renderSortIcon("approval_status")}</TableHead>
                    <TableHead className="cursor-pointer" onClick={() => handleSort("status")}>Bill Status {renderSortIcon("status")}</TableHead>
