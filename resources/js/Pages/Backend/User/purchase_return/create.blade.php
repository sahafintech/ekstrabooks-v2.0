<x-app-layout>
    ...
    <div class="main-content">
        <x-page-header title="Purchase Return" page="user" subpage="create" />

        <form method="post" class="validate" autocomplete="off" action="{{ route('purchase_returns.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="xl:col-span-9 lg:col-span-8 col-span-12">
                    <div class="box invoice-form">
                        <div class="box-body">
                                ...
                                <div class="lg:col-span-4 col-span-8">
                                    <div class="grid grid-cols-12 gap-y-3">
                                        <div class="col-span-12">
                                            <x-text-input class="text-xl font-bold" type="text" name="title" value="{{ get_business_option('purchase_return_title', 'Purchase Return') }}" placeholder="{{ _lang('Purchase Return Title') }}" />
                                        </div>
                                        <!-- <div class="col-span-12">
                            ...
                            <div class="grid grid-cols-12">
                                ...
                                <div class="md:col-span-7 col-span-12 mt-5">
                                    ...
                                    <div class="select-vendor">
                                        <select class="w-full selectize" data-selected="{{ old('vendor_id') }}" name="vendor_id">
                            ...
                            <div class="grid grid-cols-12 my-10 gap-x-5">
                                ...
                                <div class="md:col-span-4 col-span-12">
                                    ...
                                    <select class="w-full selectize" id="currency" data-selected="{{ old('currency') }}" name="currency">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="line-item">
                                                    ...
                                                    <td class="input-md align-top">
                                                        <div class="w-52">
                                                            <select name="taxes[{{ $product_id }}][]" class="multi-selector product_taxes auto-multiple-select selectize" data-selected="[{{ isset(old('taxes')[$product_id]) != null ? implode(',', old('taxes')[$product_id]) : '' }}]" data-placeholder="{{ _lang('Select Taxes') }}" multiple>
                            ...
                            <div class="grid grid-cols-12">
                                ...
                                <div class="col-span-12">
                                    ...
                                    <textarea class="w-full" name="footer">{!! xss_clean(get_business_option('purchase_return_footer', old('footer'))) !!}</textarea>
                                </div>

                                <div class="col-span-12 mt-4">
                                    <x-primary-button type="submit" class="submit-btn">{{ _lang('Save Purchase Return') }}</x-primary-button>
                                </div>
                            </div>
                        </div>
