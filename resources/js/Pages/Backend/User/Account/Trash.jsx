...
const BulkRestoreConfirmationModal = ({ show, onClose, onConfirm, processing, count }) => (
  <Modal show={show} onClose={onClose}>
    <form onSubmit={onConfirm}>
      <h2 className="text-lg font-medium">
        Are you sure you want to restore {count} selected account{count !== 1 ? 's' : ''}?
      </h2>
      <div className="mt-6 flex justify-end">
        <Button
          type="button"
...
export default function TrashList({ accounts = [], meta = {}, filters = {} }) {
  ...
  const handleDelete = (e) => {
    ...
    router.delete(route("accounts.permanent_destroy", accountToDelete), {
      preserveState: true,
      onSuccess: () => {
  ...
  const handleBulkDelete = (e) => {
    ...
    router.post(route("accounts.bulk_permanent_destroy"),
      {
  ...
  const handleRestore = (e) => {
    ...
    router.post(route("accounts.restore", accountToRestore), {
      preserveState: true,
      onSuccess: () => {
  ...
  const handleBulkRestore = (e) => {
    ...
    router.post(route("accounts.bulk_restore"),
      {
        ids: selectedAccounts
      },
      {
                ...
                <div className="flex flex-col md:flex-row gap-2">
                    <div>
                        <div className="text-red-500">
                            Total trashed accounts: {meta.total}
                        </div>
                    </div>
                </div>
                      ...
                      <TableRow key={account.id}>
                        ...
                        <TableActions
                            actions={[
                            {
                                ...
                                onClick: () => handleRestoreConfirm(account.id)
                            },
                            {
