...
export default function Create({ customers = [], products = [] }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        photochromatic_lenses: false,
        contact_lenses: false,
        anti_reflection_coating: false,
        white_lenses: false,
        high_index_lenses: false,
    ...
    // Form state for the current product being added
    ...
    const calculateTotals = () => {
        ...
        return {
            ...
            grandTotal: subTotal.toFixed(2) // Add tax calculations here if needed
        };
    };
    ...
    const handleSubmit = (e) => {
        ...
        post(route("prescriptions.store"), dataToSend);
    };
    ...
    return (
        <AuthenticatedLayout>
            <SidebarInset>
                <PageHeader page="Prescription" subpage="Create" url="prescriptions.index" />

                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <h2 className="text-lg font-medium p-4">Add New Prescription</h2>

                    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                        <form onSubmit={handleSubmit}>
                            {/* Customer */}
                            <div className="grid grid-cols-12 mt-2">
                                <Label htmlFor="prescription_date" className="md:col-span-2 col-span-12">
                                    Customer
                                </Label>
                            ...
                            {/* Result Date */}
                            <div className="grid grid-cols-12 mt-2">
                                <Label htmlFor="result_date" className="md:col-span-2 col-span-12">
                                    Result Date
                                </Label>
                                <div className="md:col-span-10 col-span-12 md:mt-0 mt-2">
                                    <DateTimePicker
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                ...
                                <div className="grid grid-cols-[70px_repeat(8,1fr)] gap-2">
                                    <div></div> {/* Empty for label */}
                                    <div className="text-center text-xs uppercase">SPH</div>
                                    <div className="text-center text-xs uppercase">CYL</div>
                                    <div className="text-center text-xs uppercase">AXIS</div>
                                    <div className="text-center text-xs uppercase">VA</div>
                                    <div className="text-center text-xs uppercase">SPH</div>
                                    <div className="text-center text-xs uppercase">CYL</div>
                                    <div className="text-center text-xs uppercase">AXIS</div>
                                    <div className="text-center text-xs uppercase">VA</div>
                                ...
                                <div className="grid grid-cols-[70px_repeat(8,1fr)] gap-2 items-center">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData("dist_sph_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_cyl_re}
                                        onChange={(e) => setData("dist_cyl_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_axis_re}
                                        onChange={(e) => setData("dist_axis_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_va_re}
                                        onChange={(e) => setData("dist_va_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_sph_le}
                                        onChange={(e) => setData("dist_sph_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_cyl_le}
                                        onChange={(e) => setData("dist_cyl_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_axis_le}
                                        onChange={(e) => setData("dist_axis_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.dist_va_le}
                                        onChange={(e) => setData("dist_va_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-[70px_repeat(8,1fr)] gap-2 items-center">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData("near_sph_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_cyl_re}
                                        onChange={(e) => setData("near_cyl_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_axis_re}
                                        onChange={(e) => setData("near_axis_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_va_re}
                                        onChange={(e) => setData("near_va_re", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_sph_le}
                                        onChange={(e) => setData("near_sph_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_cyl_le}
                                        onChange={(e) => setData("near_cyl_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_axis_le}
                                        onChange={(e) => setData("near_axis_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                    <Input
                                        value={data.near_va_le}
                                        onChange={(e) => setData("near_va_le", e.target.value)}
                                        className="h-9 text-sm"
                                    />
                                </div>
                                ...
                                <div className="my-4">
                                    <div className="grid grid-cols-[70px_1fr] gap-2 items-center">
                                        <div className="text-xs uppercase">IPD</div>
                                        <div className="md:w-1/2 w-full">
                                            <Input
                                                value={data.ipd}
                                                onChange={(e) => setData("ipd", e.target.value)}
                                                className="h-9 text-sm"
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-3 gap-4 mt-2">
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => setData("glasses", checked)}
                                    />
                                    <Label htmlFor="glasses" className="text-xs">Glasses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="photochromatic_lenses"
                                        checked={data.photochromatic_lenses}
                                        onCheckedChange={(checked) => setData("photochromatic_lenses", checked)}
                                    />
                                    <Label htmlFor="photochromatic_lenses" className="text-xs">Photochromatic Lenses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="high_index_lenses"
                                        checked={data.high_index_lenses}
                                        onCheckedChange={(checked) => setData("high_index_lenses", checked)}
                                    />
                                    <Label htmlFor="high_index_lenses" className="text-xs">High Index Lenses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="polycarbonate"
                                        checked={data.polycarbonate}
                                        onCheckedChange={(checked) => setData("polycarbonate", checked)}
                                    />
                                    <Label htmlFor="polycarbonate" className="text-xs">Polycarbonate</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="contact_lenses"
                                        checked={data.contact_lenses}
                                        onCheckedChange={(checked) => setData("contact_lenses", checked)}
                                    />
                                    <Label htmlFor="contact_lenses" className="text-xs">Contact Lenses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="bi_focal_lenses"
                                        checked={data.bi_focal_lenses}
                                        onCheckedChange={(checked) => setData("bi_focal_lenses", checked)}
                                    />
                                    <Label htmlFor="bi_focal_lenses" className="text-xs">Bi-Focal Lenses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="progressive_lenses"
                                        checked={data.progressive_lenses}
                                        onCheckedChange={(checked) => setData("progressive_lenses", checked)}
                                    />
                                    <Label htmlFor="progressive_lenses" className="text-xs">Progressive Lenses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="anti_reflection_coating"
                                        checked={data.anti_reflection_coating}
                                        onCheckedChange={(checked) => setData("anti_reflection_coating", checked)}
                                    />
                                    <Label htmlFor="anti_reflection_coating" className="text-xs">Anti-Reflection Coating</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="single_vision"
                                        checked={data.single_vision}
                                        onCheckedChange={(checked) => setData("single_vision", checked)}
                                    />
                                    <Label htmlFor="single_vision" className="text-xs">Single Vision</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="plastic"
                                        checked={data.plastic}
                                        onCheckedChange={(checked) => setData("plastic", checked)}
                                    />
                                    <Label htmlFor="plastic" className="text-xs">Plastic</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="white_lenses"
                                        checked={data.white_lenses}
                                        onCheckedChange={(checked) => setData("white_lenses", checked)}
                                    />
                                    <Label htmlFor="white_lenses" className="text-xs">White Lenses</Label>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        id="blue_cut"
                                        checked={data.blue_cut}
                                        onCheckedChange={(checked) => setData("blue_cut", checked)}
                                    />
                                    <Label htmlFor="blue_cut" className="text-xs">Blue Cut</Label>
                                </div>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) => setData("prescription_description", e.target.value)}
                                    rows={4}
                                />
                            </div>
                            ...
                            <div className="mt-4">
                                <div className="md:w-1/2 w-full">
                                    <div className="grid grid-cols-5 gap-2 border-b pb-2">
                                        <div className="text-xs uppercase font-medium">Name</div>
                                        <div className="text-xs uppercase font-medium">Description</div>
                                        <div className="text-xs uppercase font-medium">Quantity</div>
                                    ...
                                    {selectedProducts.length > 0 ? (
                                        <>
                                            {selectedProducts.map((product, index) => (
                                                <div key={product.id} className="grid grid-cols-5 gap-2 py-2 border-b items-center">
                                        ...
                                        <div className="py-4 text-center text-gray-500 text-sm">No products added</div>
                                    )}
                                </div>
                            </div>
