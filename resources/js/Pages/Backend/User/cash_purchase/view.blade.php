<x-app-layout>
	...
	<div class="main-content">
		<x-page-header title="Cash Purchase" page="user" subpage="view" />
				...
				<div>
					...
					<div class="mt-3">
						<div id="bar-1" role="tabpanel" aria-labelledby="bar-item-1" class="">
							@include('backend.user.cash_purchase.action')
							@include('backend.user.cash_purchase.template.loader')
						</div>
						<div id="bar-2" class="hidden" role="tabpanel" aria-labelledby="bar-item-2">
							@include('backend.user.cash_purchase.attachments')
						</div>
					</div>
				</div>
			</div>
