<x-app-layout>
	...
	<div class="main-content">
		<x-page-header title="Credit Invoices" page="user" subpage="create" />
								...
								<div class="lg:col-span-4 col-span-8">
									<div class="grid grid-cols-12 gap-y-3">
										<div class="col-span-12">
											<x-text-input class="text-xl font-bold" type="text" name="title" value="{{ get_business_option('invoice_title', 'Invoice') }}" placeholder="{{ _lang('Invoice Title') }}" />
										</div>
							...
							<div class="grid grid-cols-12">
								...
								<div class="col-span-12 mt-3">
									...
									<div class="col-span-12 grid grid-cols-12">
										...
										<input type="number" step="any" class="col-span-9" name="discount_value" id="discount_value" min="0" value="{{ old('discount_value',0) }}">
									</div>
								</div>
