...
const SYSTEM_FIELDS = [
  {
    ...
    required: false,
    description: "Rows with the same invoice number become one invoice with multiple items",
  },
...
export default function Import() {
    ...
    previewData.headers.forEach((header) => {
      ...
      for (const field of SYSTEM_FIELDS) {
        ...
        if (normalizedHeader === normalizedFieldValue) {
          ...
          (normalizedHeader.includes("invoice_number") || normalizedHeader.includes("invoice_no")) &&
          field.value === "invoice_number"
        ) {
          score = 95;
        } else if (normalizedHeader.includes("invoice") && normalizedHeader.includes("date") && field.value === "invoice_date") {
          score = 95;
          ...
          score = 90;
        } else if (normalizedHeader.includes("client") && field.value === "client_name") {
          score = 85;
          ...
          score = 75;
        } else if (normalizedHeader.includes("transaction") && normalizedHeader.includes("currency") && field.value === "currency") {
          score = 95;
  ...
  const handleUploadFile = useCallback(() => {
    ...
    setIsUploading(true);
    router.post(route("invoices.import.upload"), formData, {
      onSuccess: () => {
        setCurrentStep(1);
      },
      onError: (errors) => {
  ...
  const requiredMappings = ["invoice_date", "due_date", "customer_name", "product_name", "quantity", "unit_cost"];
    ...
    <AuthenticatedLayout>
      ...
      <SidebarInset>
        <div className="main-content">
          <PageHeader page="Invoices" subpage="Import" url="invoices.index" />
            ...
            {currentStep === 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Select an Excel or CSV file to import invoices</CardDescription>
                </CardHeader>
                <CardContent className="space-y-5">
                  ...
                  <Alert className="border-blue-500/30 bg-blue-500/5">
                    ...
                    <AlertDescription>
                      <h4 className="font-medium mb-2 text-blue-700">Multi-item Invoice Import</h4>
                      <ul className="text-sm space-y-1 text-blue-600">
                        <li>- Duplicate <strong>Invoice Number</strong> values are supported and grouped into one invoice with multiple items</li>
                        <li>- Shared invoice fields such as dates, customer, currency, and discounts are taken from the first row in each invoice group</li>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      <ul className="text-sm space-y-1">
                        ...
                        <li>- Required fields: Invoice Date, Due Date, Customer Name, Product Name, Quantity, Unit Cost</li>
                        <li>- Optional <strong>Tax</strong> column: enter tax names exactly as configured in Tax Database</li>
                        <li>- Products are matched by name and stock-managed items must have enough stock available</li>
                        <li>- Customers, clients, projects, currencies, and taxes are matched by name</li>
                      </ul>
                    </AlertDescription>
                  </Alert>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Map your file columns to invoice fields</CardDescription>
                  </div>
                ...
                {previewData.unique_invoices && previewData.unique_invoices < previewData.total_rows && (
                  <Alert className="border-blue-500/30 bg-blue-500/5">
                    ...
                    <AlertDescription className="text-blue-600">
                      ...
                      <span className="font-medium">{previewData.unique_invoices} invoices</span> based on their invoice numbers.
                    </AlertDescription>
                  </Alert>
                )}
                          ...
                          {previewData.preview_records.map((record, index) => (
                            <TableRow key={index}>
                              ...
                              <TableCell className="text-muted-foreground">
                                {record.data.invoice_number || <span className="italic">-</span>}
                              </TableCell>
                              <TableCell className="text-muted-foreground">
