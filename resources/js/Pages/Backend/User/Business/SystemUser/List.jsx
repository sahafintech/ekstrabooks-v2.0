...
export default function List({ business = {}, users = {}, meta = {}, filters = {} }) {
  ...
  const handleDeleteAll = (e) => {
    ...
    router.post(route('user.bulk_action'), {
          ...
          <div className="p-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
              <div className="flex flex-col md:flex-row gap-4">
                <Link href={route("system_users.invite", business.id)}>
                  <Button>
                  ...
                  {users.length > 0 ? (
                    users.map((user) => (
                      <TableRow key={user.id}>
                        ...
                        <TableCell>{user.pivot.role_id === null ? 'Admin' : user.roles.find(role => role.id === user.pivot.role_id).name}</TableCell>
                            ...
                            actions={[
                              {
                                ...
                                href: route("system_users.change_role", [user.id, business.id]),
                              },
                              {
                                label: "Delete",
