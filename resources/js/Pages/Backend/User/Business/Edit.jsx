...
export default function Edit({ business_types = [], currencies = [], countries = [], business }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        default: "0",
        bank_accounts: {
            bank_name: business.bank_accounts.map(bank_account => bank_account.bank_name),
            account_name: business.bank_accounts.map(bank_account => bank_account.account_name),
            account_number: business.bank_accounts.map(bank_account => bank_account.account_number),
            account_currency: business.bank_accounts.map(bank_account => bank_account.account_currency),
            branch: business.bank_accounts.map(bank_account => bank_account.branch),
            swift_code: business.bank_accounts.map(bank_account => bank_account.swift_code),
            display_on_invoice: business.bank_accounts.map(bank_account => bank_account.display_on_invoice),
        },
        _method: "PUT",
    });
