                                    ...
                                    {returns.length > 0 ? (
                                        returns.map((purchase_return) => (
                                            <TableRow key={purchase_return.id}>
                                                ...
                                                <TableCell className="text-right">{purchase_return.grand_total}</TableCell>
                                                <TableCell className="text-right">{purchase_return.paid}</TableCell>
                                                <TableCell className="text-right">{purchase_return.grand_total - purchase_return.paid}</TableCell>
                                                <TableCell>
