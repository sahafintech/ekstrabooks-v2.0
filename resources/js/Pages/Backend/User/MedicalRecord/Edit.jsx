...
export default function Create({ customers = [], medicalRecord }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        keratometry_re: medicalRecord.keratometry_re,
        keratometry_le: medicalRecord.keratometry_le,

        trial_frame_va_re: medicalRecord.trial_frame_va_re,
        trial_frame_va_le: medicalRecord.trial_frame_va_le,
        ...
        eso: medicalRecord.eso,
        exo: medicalRecord.exo,
        hypo: medicalRecord.hypo,
        hyper: medicalRecord.hyper,
        tropia: medicalRecord.tropia,
        phoria: medicalRecord.phoria,
