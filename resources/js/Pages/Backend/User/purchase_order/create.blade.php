<x-app-layout>
	...
	<div class="main-content">
		<x-page-header title="Purchase Order" page="user" subpage="create" />

		<form method="post" class="validate" autocomplete="off" action="{{ route('purchase_orders.store') }}" enctype="multipart/form-data">
			@csrf
								...
								<div class="lg:col-span-4 col-span-8">
									<div class="grid grid-cols-12 gap-y-3">
										<div class="col-span-12">
											<x-text-input class="text-xl font-bold" type="text" name="title" value="Purchase Order" placeholder="{{ _lang('Order Title') }}" required />
										</div>
