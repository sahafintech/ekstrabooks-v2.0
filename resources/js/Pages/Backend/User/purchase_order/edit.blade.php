<x-app-layout>
	...
	<div class="main-content">
		<x-page-header title="Purchase Order" page="user" subpage="update" />

		<form method="post" class="validate" autocomplete="off" action="{{ route('purchase_orders.update', $id) }}" enctype="multipart/form-data">
			@csrf
						...
						<div class="box-body">
								...
								<div class="lg:col-span-4 col-span-8">
									<div class="grid grid-cols-12 gap-y-3">
										<div class="col-span-12">
											<x-text-input class="text-xl font-bold" type="text" name="title" value="{{ $purchase->title }}" placeholder="{{ _lang('Order Title') }}" required />
										</div>
							...
							<div class="grid grid-cols-12">
								<div class="col-span-12 space-y-3">
									<div class="grid grid-cols-12">
										<x-input-label class="xl:col-span-2 col-span-12" value="{{ _lang('Order Date') }}" />
