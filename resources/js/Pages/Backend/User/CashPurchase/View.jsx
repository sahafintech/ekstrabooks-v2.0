...
export default function View({ bill, attachments, decimalPlace, approvalUsersCount, hasConfiguredApprovers, checkerUsersCount, hasConfiguredCheckers }) {
    ...
    const submitApprovalAction = () => {
        ...
        router.post(route(`cash_purchases.${approvalAction}`, bill.id), {
            ...
            onSuccess: () => {
                ...
                toast.success(`Purchase ${approvalAction}d successfully`);
            },
            onError: (errors) => {
                setIsSubmittingApproval(false);
                if (errors.comment) {
                    ...
                    toast.error(`Failed to ${approvalAction} purchase`);
                }
            }
        });
    };
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                                        This cash purchase cannot be approved or rejected until approvers are configured.
                                    ...
                                    <TableCell colSpan={5} className="text-center py-8">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                This cash purchase cannot be approved until approvers are configured.
                                            </p>
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    <Textarea
                        ...
                        placeholder={approvalAction === 'approve' ? "Add a comment (optional)" : "Explain why you're rejecting this purchase"}
                        rows={4}
                        className="w-full"
                    />
                </div>
