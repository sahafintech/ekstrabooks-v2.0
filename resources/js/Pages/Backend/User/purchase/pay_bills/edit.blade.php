<x-app-layout>
    ...
    <div class="main-content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ route('bill_payments.update', $id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input name="_method" type="hidden" value="PATCH">
                    <div class="grid grid-cols-12 gap-x-2">
                        <div class="md:col-span-6 col-span-12 mt-3">
                            <x-input-label value="{{ _lang('Vendors') }}" />
                            <select id="vendors" class="w-full auto-select selectize" data-selected="{{ $payment->vendor_id }}" name="vendor_id" required>
                        ...
                        <div class="col-span-12 mt-3">
                            ...
                            <div class="table-bordered rounded-sm ti-custom-table-head overflow-auto mt-3 bg-white">
                                <table id="invoices-table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                    ...
                                    <tbody>
                                        @foreach($payment->purchases as $invoice)
                                        <tr>
