<x-app-layout>
	...
	<div class="main-content">
		...
		<form method="post" class="validate" autocomplete="off" action="{{ route('bill_invoices.store') }}" enctype="multipart/form-data">
			@csrf
								...
								<div class="lg:col-span-4 col-span-8">
									<div class="grid grid-cols-12 gap-y-3">
										<div class="col-span-12">
											<x-text-input class="text-xl font-bold" type="text" name="title" value="{{ get_business_option('bill_title', 'Bill') }}" placeholder="{{ _lang('Invoice Title') }}" required />
										</div>
							...
							<div class="grid grid-cols-12">
								<div class="col-span-12 space-y-3">
									...
									<div class="grid grid-cols-12">
										...
										<div class="xl:col-span-5 col-span-12">
											<x-text-input type="text" class="flatpickr-input" id="date" name="due_date" value="{{ old('due_date') }}" required placeholder="Select Date" />
										</div>
									</div>
								</div>
