<x-app-layout>
    ...
    <div class="main-content">
        ...
        <form method="post" class="validate" autocomplete="off" action="{{ route('sales_returns.update', $id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="box-body">
                                ...
                                <div class="lg:col-span-4 col-span-8">
                                    <div class="grid grid-cols-12 gap-y-3">
                                        <div class="col-span-12">
                                            <x-text-input class="text-xl font-bold" type="text" name="title" value="{{ get_business_option('sales_return_title', $return->title) }}" placeholder="{{ _lang('Sales Return Title') }}" />
                                        </div>
                                        <div class="col-span-12 hidden">
                                            <select id="type" class="selectize auto-select" data-selected="{{ $return->type }}" name="type">
                            ...
                            <div class="grid grid-cols-12">
                                <div class="col-span-12 grid grid-cols-12 gap-x-2">
                                    ...
                                    <div class="md:col-span-4 col-span-12 account {{ $return->type == 'credit' ? 'hidden' : '' }}">
                                        <x-input-label value="{{ _lang('Credit account') }}" />
                                        <select class="w-full selectize auto-select" data-selected="" name="account_id">
                                    ...
                                    <div class="md:col-span-4 col-span-12 method {{ $return->type == 'credit' ? 'hidden' : '' }}">
                                ...
                                <div class="md:col-span-7 col-span-12 mt-5">
                                    ...
                                    <div class="select-customer">
                                        <select class="w-full selectize auto-select" data-selected="{{ $return->customer_id }}" name="customer_id">
                            ...
                            <div class="grid grid-cols-12">
                                ...
                                <div class="col-span-12">
                                    ...
                                    <textarea class="w-full" name="footer">{!! xss_clean(get_business_option('sales_return_footer', $return->note)) !!}</textarea>
                                </div>
