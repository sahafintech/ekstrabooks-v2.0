<x-app-layout>
    ...
    <div class="main-content">
        <x-page-header title="Sales Returns" page="user" subpage="list" />

        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="box">
                    <div class="box-header flex items-center justify-between">
                        <h5>{{ _lang('Sales Retuns') }}</h5>
                        ...
                        <div class="grid grid-cols-12 gap-x-6">
                            <div class="lg:col-span-3 col-span-12 mb-2">
                                <select class="w-full selectize" multiple name="status">
                                    ...
                                    <option value="0">{{ _lang('Active') }}</option>
                                    <option value="1">{{ _lang('Refund') }}</option>
                                </select>
                            </div>
                        </div>
                                            ...
                                            <div class="hs-dropdown ti-dropdown">
                                                ...
                                                <div class="hs-dropdown-menu ti-dropdown-menu divide-y divide-gray-200" aria-labelledby="hs-dropdown-with-icons">
                                                    <div class="ti-dropdown-divider">
                                                        @if($return->status == 0)
                                                        <a class="ti-dropdown-item" href="{{ route('sales_returns.edit', $return['id']) }}">
                                                            <i class="ri-edit-box-line text-lg"></i>
                                                            Edit
                                                        </a>
                                                        @endif
                                                        <a class="ti-dropdown-item" href="{{ route('sales_returns.show', $return['id']) }}">
                                                            <i class="ri-eye-line text-lg"></i>
                                                            View
                                                        </a>
                                                        @if($return->status == 0 || $return->status == 2)
                                                        <a class="ti-dropdown-item ajax-modal" href="{{ route('sales_returns.refund', $return['id']) }}" data-hs-overlay="#refund-modal">
