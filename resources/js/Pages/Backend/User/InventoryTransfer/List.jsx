...
import { MoreVertical, FileUp, FileDown, Plus, Eye, Trash2, Edit, ChevronUp, ChevronDown, Send, Package, ArrowUpDown, TruckIcon, Building2 } from "lucide-react";
...
const ImportTransfersModal = ({ show, onClose, onSubmit, processing }) => (
    <Modal show={show} onClose={onClose} maxWidth="3xl">
        <form onSubmit={onSubmit}>
            <div className="ti-modal-header">
                <h3 className="text-lg font-bold">Import Transfers</h3>
            </div>
            <div className="ti-modal-body grid grid-cols-12">
                <div className="col-span-12">
                    <div className="flex items-center justify-between">
                        ...
                        <a href="/uploads/media/default/sample_transfers.xlsx" download>
                            <Button variant="secondary" size="sm" type="button">
                                Use This Sample File
                            </Button>
                        </a>
                    </div>
                    <input type="file" className="w-full dropify" name="transfers_file" required />
                </div>
...
const DeleteAllTransfersModal = ({ show, onClose, onConfirm, processing, count }) => (
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to delete {count} selected transfer{count !== 1 ? 's' : ''}?
            </h2>
            <div className="mt-6 flex justify-end">
                <Button
                    type="button"
...
const SummaryCards = ({ summary = {} }) => {
    const cards = [
        ...
        {
            title: "Outgoing",
            value: summary.outgoing_transfers || 0,
            description: "Transfers sent out",
            icon: ArrowUpDown,
            iconColor: "text-orange-500"
        },
        {
            title: "Incoming",
            value: summary.incoming_transfers || 0,
            description: "Transfers received",
            icon: Package,
...
export default function List({
    ...
    const handleSort = (column) => {
        ...
        router.get(
            route("inventory_transfers.index"),
    ...
    const handleDelete = (e) => {
        ...
        router.delete(route('inventory_transfers.destroy', transferToDelete), {
            onSuccess: () => {
    ...
    const handleDeleteAll = (e) => {
        ...
        router.post(route('inventory_transfers.bulk_destroy'),
            {
    ...
    const handleImport = (e) => {
        ...
        router.post(route('inventory_transfers.import'), formData, {
            onSuccess: () => {
    ...
    const exportTransfers = () => {
        window.location.href = route("inventory_transfers.export");
    };
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            <div className="flex flex-col md:flex-row gap-2">
                                <Link href={route("inventory_transfers.create")}>
                                    <Button>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        ...
                                        <DropdownMenuItem onClick={exportTransfers}>
                                            <FileDown className="mr-2 h-4 w-4" /> Export
                                        </DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                                <Link href={route("inventory_transfers.trash")}>
                                                        ...
                                                        actions={[
                                                            {
                                                                ...
                                                                href: route("inventory_transfers.show", transfer.id),
                                                            },
                                                            {
                                                                label: "Edit",
                                                                icon: <Edit className="h-4 w-4" />,
                                                                href: route("inventory_transfers.edit", transfer.id),
                                                                show: transfer.status === "draft" && transfer.from_entity_id === currentBusinessId,
                                                            },
                                                            {
                                                                label: "Delete",
