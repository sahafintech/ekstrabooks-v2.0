                        ...
                        <tbody>
                            {receipt.items.map((item, i) => (
                                <tr key={i}>
                                    ...
                                    <td style={{ textAlign: 'right', padding: '2px 0', fontSize: 10 }}>{formatCurrency({ amount: item.unit_cost, currency: receipt.currency })}</td>
                                    <td style={{ textAlign: 'right', padding: '2px 0', fontSize: 10 }}>{formatCurrency({ amount: item.sub_total, currency: receipt.currency })}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
