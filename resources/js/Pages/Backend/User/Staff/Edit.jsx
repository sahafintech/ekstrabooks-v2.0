...
export default function Edit({ employee, departments = [], designations = [] }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Update the form with the latest update_company_details value
    const submitData = {
      ...form,
      update_company_details: updateCompanyDetails ? "1" : "0"
    };
    
    router.put(route("staffs.update", employee.id), submitData, {
      onSuccess: () => {
        setProcessing(false);
      },
      onError: () => {
  ...
  const toggleUpdateCompanyDetails = (checked) => {
    setUpdateCompanyDetails(checked);
  };
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-12 mt-2">
                <Label htmlFor="employee_id" className="md:col-span-2 col-span-12">
                  Employee ID {updateCompanyDetails && <span className="text-red-500">*</span>}
                </Label>
              ...
              <div className="flex justify-end mb-4">
                <div className="flex items-center space-x-2">
                  <Label htmlFor="update-company-details">Update Employment Details</Label>
                  <Switch
                    id="update-company-details"
                    checked={updateCompanyDetails}
                    onCheckedChange={toggleUpdateCompanyDetails}
                  />
                </div>
              </div>
              <Separator className="my-2" />
              ...
              <div className="grid grid-cols-12 mt-2">
                <Label htmlFor="department_id" className="md:col-span-2 col-span-12">
                  Department {updateCompanyDetails && <span className="text-red-500">*</span>}
                </Label>
                <div className="md:col-span-10 col-span-12 md:mt-0 mt-2">
              ...
              <div className="grid grid-cols-12 mt-2">
                <Label htmlFor="designation_id" className="md:col-span-2 col-span-12">
                  Designation {updateCompanyDetails && <span className="text-red-500">*</span>}
                </Label>
                <div className="md:col-span-10 col-span-12 md:mt-0 mt-2">
                  <div className="md:w-1/2 w-full">
                    <SearchableCombobox
