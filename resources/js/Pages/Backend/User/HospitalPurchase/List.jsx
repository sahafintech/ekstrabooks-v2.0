    ...
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to delete this hospital purchase?
            </h2>
    ...
    <Modal show={show} onClose={onClose} maxWidth="3xl">
        <form onSubmit={onSubmit}>
            <div className="ti-modal-header">
                <h3 className="text-lg font-bold">Import Hospital Purchases</h3>
            </div>
            <div className="ti-modal-body grid grid-cols-12">
                <div className="col-span-12">
                    <div className="flex items-center justify-between">
                        <label className="block font-medium text-sm text-gray-700">
                            Hospital Purchases File
                        </label>
                        <a
...
const DeleteAllBillsModal = ({
    ...
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to delete {count} selected hospital purchase
                {count !== 1 ? "s" : ""}?
            </h2>
            <div className="mt-6 flex justify-end">
                <Button
    ...
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            ...
            <p className="text-gray-600 mb-6">
                Are you sure you want to approve {count} selected hospital purchase{count !== 1 ? "s" : ""}?
                This will update your approval status for these hospital purchases.
            </p>
...
const BulkRejectModal = ({ show, onClose, onConfirm, processing, count }) => (
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            ...
            <p className="text-gray-600 mb-6">
                Are you sure you want to reject {count} selected hospital purchase{count !== 1 ? "s" : ""}?
                This will update your rejection status for these hospital purchases.
            </p>
            <div className="flex justify-end gap-3">
                <Button
                    type="button"
...
const BulkVerifyModal = ({ show, onClose, onConfirm, processing, count }) => (
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            ...
            <p className="text-gray-600 mb-6">
                Are you sure you want to verify {count} selected hospital purchase{count !== 1 ? "s" : ""}?
                This will update your verification status for these hospital purchases.
            </p>
            <div className="flex justify-end gap-3">
                <Button
                    type="button"
...
const ShareSelectedModal = ({
    ...
    <Modal show={show} onClose={onClose} maxWidth="4xl">
        <form onSubmit={onSubmit} className="space-y-4">
            <h2 className="text-lg font-medium">Share Selected Hospital Purchases via Email</h2>
            <p className="text-sm text-gray-600">
                {selectionCount} hospital purchase{selectionCount !== 1 ? "s" : ""} will be inserted into the email body.
            </p>
...
const SummaryCards = ({ summary = {} }) => {
    const cards = [
        {
            title: "Total Hospital Purchases",
            value: summary.total_bills || 0,
            description: "Total number of hospital purchases",
            icon: Receipt,
        ...
        },
        {
            ...
            description: "Total amount of all hospital purchases",
            icon: DollarSign,
        ...
        },
        {
            ...
            description: "Approved hospital purchases",
            icon: CheckCircle,
        ...
        },
        {
            ...
            description: "Pending hospital purchases",
            icon: Clock,
...
export default function List({
    ...
    const buildEmailBody = (recipientId) => {
        ...
        const rows = selected
            .map((b) => {
                let row = rowTemplate;
                row = row.replace(/{{purchaseUrl}}/g, `/user/hospital_purchases/${b.id}`);
    ...
    const handleDelete = (e) => {
        ...
        router.delete(route("hospital_purchases.destroy", billToDelete), {
            onSuccess: () => {
                ...
                toast({
                    title: "Hospital Purchase Deleted",
                    description: "Hospital purchase has been deleted successfully.",
                });
            },
            onError: () => {
                setProcessing(false);
                toast({
                    variant: "destructive",
                    title: "Error",
                    description: "There was an error deleting the hospital purchase.",
                });
            },
        });
    };
    ...
    const handleDeleteAll = (e) => {
        ...
        router.post(
            route("hospital_purchases.bulk_destroy"),
            {
                ids: selectedBills,
            },
            {
    ...
    const handleImport = (e) => {
        ...
        router.post(route("hospital_purchases.import"), formData, {
            onSuccess: () => {
                setShowImportModal(false);
                setProcessing(false);
                toast({
                    title: "Import Successful",
                    description: "Hospital purchases have been imported successfully.",
                });
            },
            onError: (errors) => {
                setProcessing(false);
    ...
    const handleBulkApprove = (e) => {
        ...
        setProcessing(true);
        router.post(
            route("hospital_purchases.bulk_approve"),
            { ids: selectedBills },
            {
                onSuccess: () => {
                    setProcessing(false);
    ...
    const handleBulkReject = (e) => {
        ...
        setProcessing(true);
        router.post(
            route("hospital_purchases.bulk_reject"),
            { ids: selectedBills },
            {
                onSuccess: () => {
                    setProcessing(false);
    ...
    const handleBulkVerify = (e) => {
        ...
        setProcessing(true);
        router.post(
            route("hospital_purchases.bulk_verify"),
            { ids: selectedBills },
            {
                onSuccess: () => {
                    setProcessing(false);
    ...
    const handleShareSubmit = (e) => {
        ...
        setShareErrors({});
        router.post(
            route("hospital_purchases.bulk_email"),
            {
                ids: selectedBills,
        ...
        <AuthenticatedLayout>
            ...
            <SidebarInset>
                <div className="main-content">
                    <PageHeader
                        page="Hospital Purchases"
                        subpage="List"
                        url="hospital_purchases.index"
                    />
                    <div className="p-4">
                        <SummaryCards summary={summary} />
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            <div className="flex flex-col md:flex-row gap-2">
                                <Link href={route("hospital_purchases.create")}>
                                    <Button>
                                        <Plus className="h-4 w-4 mr-2" />
                                        Add Hospital Purchase
                                    </Button>
                                </Link>
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <Link href={route("hospital_purchases.import.page")}>
                                            <DropdownMenuItem>
                                ...
                                <Link href={route("hospital_purchases.trash")}>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                <Input
                                    placeholder="Search hospital purchases..."
                                    value={search}
