              ...
              <Card>
                ...
                <CardContent className="space-y-5">
                  ...
                  <Alert className="border-blue-500/30 bg-blue-500/5">
                    ...
                    <AlertDescription>
                      <h4 className="font-medium mb-2 text-blue-700">Multi-item Hospital Purchase Import</h4>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <Card className="text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Unique Hospital Purchases</p>
                  </Card>
                  <Card className="text-center p-4">
                ...
                {previewData.unique_bills && previewData.unique_bills < previewData.total_rows && (
                  <Alert className="border-blue-500/30 bg-blue-500/5">
                    ...
                    <AlertDescription className="text-blue-600">
                      <span className="font-medium">{previewData.total_rows} rows</span> will be grouped into <span className="font-medium">{previewData.unique_bills} bills</span> based on their purchase numbers.
                    </AlertDescription>
                  </Alert>
                )}
