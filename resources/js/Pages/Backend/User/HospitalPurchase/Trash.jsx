    ...
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to permanently delete this hospital purchase?
            </h2>
            <div className="mt-6 flex justify-end">
                ...
                <Button
                    ...
                    disabled={processing}
                >
                    Permanently Delete Hospital Purchase
                </Button>
            </div>
        </form>
    </Modal>
...
const DeleteAllBillsModal = ({
    ...
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to permanently delete {count} selected hospital purchase
                {count !== 1 ? "s" : ""}?
            </h2>
            <div className="mt-6 flex justify-end">
                <Button
...
const RestoreBillModal = ({ show, onClose, onConfirm, processing }) => (
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to restore this hospital purchase?
            </h2>
            <div className="mt-6 flex justify-end">
                <Button
                    type="button"
...
const RestoreAllBillsModal = ({
    ...
    <Modal show={show} onClose={onClose}>
        <form onSubmit={onConfirm}>
            <h2 className="text-lg font-medium">
                Are you sure you want to restore {count} selected hospital purchase
                {count !== 1 ? "s" : ""}?
            </h2>
            <div className="mt-6 flex justify-end">
                <Button
...
export default function TrashList({
    ...
    const handleDelete = (e) => {
        ...
        router.delete(route("hospital_purchases.permanent_destroy", billToDelete), {
            onSuccess: () => {
    ...
    const handleDeleteAll = (e) => {
        ...
        router.post(
            route("hospital_purchases.bulk_permanent_destroy"),
            {
                ids: selectedBills,
            },
            {
    ...
    const handleRestore = (e) => {
        ...
        router.post(route("hospital_purchases.restore", billToRestore), {
            onSuccess: () => {
                ...
                toast({
                    title: "Hospital Purchase Restored",
                    description: "Hospital purchase has been restored successfully.",
                });
            },
            onError: () => {
                setProcessing(false);
                toast({
                    variant: "destructive",
                    title: "Error",
                    description: "There was an error restoring the hospital purchase.",
                });
            },
        });
    };
    ...
    const handleRestoreAll = (e) => {
        ...
        router.post(
            route("hospital_purchases.bulk_restore"),
            {
                ids: selectedBills,
            },
            {
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            <div>
                                <div className="text-red-500">
                                    Total trashed hospital purchases: {meta.total}
                                </div>
                            </div>
                            <div className="flex flex-col md:flex-row gap-4 md:items-center">
                                <Input
                                    placeholder="Search trashed hospital purchases..."
                                    value={search}
