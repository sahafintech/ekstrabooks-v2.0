...
export default function View({ bill, attachments, decimalPlace, email_templates, approvalUsersCount, hasConfiguredApprovers, checkerUsersCount, hasConfiguredCheckers }) {
    ...
    const submitApprovalAction = () => {
        ...
        router.post(route(`hospital_purchases.${approvalAction}`, bill.id), {
            ...
            onSuccess: () => {
                ...
                toast.success(`Hospital purchase ${approvalAction}d successfully`);
            },
            onError: (errors) => {
                setIsSubmittingApproval(false);
                if (errors.comment) {
                    ...
                    toast.error(`Failed to ${approvalAction} hospital purchase`);
                }
            }
        });
    };
    ...
    const submitVerifyAction = () => {
        ...
        router.post(route('hospital_purchases.verify', bill.id), {
            ...
            onSuccess: () => {
                ...
                toast.success('Hospital purchase verified successfully');
            },
            onError: (errors) => {
                setIsSubmittingVerify(false);
                if (errors.comment) {
                    ...
                    toast.error('Failed to verify hospital purchase');
                }
            }
        });
    };
    ...
    const handleEmailSubmit = (e) => {
        e.preventDefault();
        post(route("hospital_purchases.send_email", bill.id), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleDownloadPDF = () => {
        window.open(route('hospital_purchases.pdf', bill.id), '_blank');
    };

    const handleShareLink = () => {
        const link = route('hospital_purchases.show_public_bill_invoice', bill.short_code);
        setShareLink(link);
    ...
    const handleWhatsAppShare = () => {
        const text = `Check out this hospital purchase: ${shareLink}`;
    ...
    const canMakePayment = Number(bill.grand_total) > Number(bill.paid);
    ...
    return (
        <AuthenticatedLayout>
            ...
            <SidebarInset>
                ...
                <div className="space-y-4">
                    <PageHeader
                        ...
                        subpage={`Hospital Purchase #${bill.bill_no}`}
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                {canMakePayment && (
                                    <DropdownMenuItem asChild>
                                        <Link
                                            href={route("bill_payments.create", {
                                                context: "hospital",
                                ...
                                <DropdownMenuItem asChild>
                                    <Link href={route("hospital_purchases.edit", bill.id)} className="flex items-center">
                                        <Edit className="mr-2 h-4 w-4" />
                                        <span>Edit Hospital Purchase</span>
                                    </Link>
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                                        This hospital purchase cannot be approved or rejected until approvers are configured.
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
                                        This hospital purchase cannot be verified until checkers are configured.
                    ...
                    >
                        <div className="mb-6">
                            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">
                                Hospital Purchase Attachments
                            </h2>
                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                View and download files attached to this hospital purchase
                            </p>
                        </div>
                        ...
                        <div className="p-6 sm:p-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                                ...
                                <div className="sm:text-right">
                                    ...
                                    <div className="mt-2 text-sm">
                                        <p><span className="font-medium">Hospital Purchase #:</span> {bill.bill_no}</p>
                                        <p><span className="font-medium">Hospital Purchase Date:</span> {bill.purchase_date}</p>
                                    ...
                                    <div className="mt-4 sm:flex sm:justify-end">
                                        <QRCodeSVG
                                            value={route('hospital_purchases.show_public_bill_invoice', bill.short_code)}
                                            size={100}
                                            level="H"
                                            includeMargin={true}
                            ...
                            <div className="mb-8">
                                <h3 className="font-medium text-lg mb-2">Supplier:</h3>
            ...
            <DrawerComponent
                ...
                title="Hospital Purchase Approvals"
                position="right"
                width="w-4xl"
            >
                <div className="p-4">
                                    ...
                                    <TableCell colSpan={5} className="text-center py-8">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                This hospital purchase cannot be approved until approvers are configured.
                                            </p>
            ...
            >
                    ...
                    <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 flex items-center">
                        {approvalAction === 'approve' ? (
                            <>
                                ...
                                Approve Hospital Purchase
                            </>
                        ) : (
                            <>
                                <XCircle className="h-5 w-5 mr-2 text-red-600" />
                                Reject Hospital Purchase
                            </>
                        )}
                    </h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        {approvalAction === 'approve'
                            ...
                            : 'Please provide a reason for rejecting this hospital purchase'}
                    </p>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <Textarea
                        ...
                        placeholder={approvalAction === 'approve' ? "Add a comment (optional)" : "Explain why you're rejecting this hospital purchase"}
                        rows={4}
                        className="w-full"
                    />
                </div>
            ...
            <DrawerComponent
                ...
                title="Hospital Purchase Verification"
                position="right"
                width="w-4xl"
            >
                <div className="p-4">
