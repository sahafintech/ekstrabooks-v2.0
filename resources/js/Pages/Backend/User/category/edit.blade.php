<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ route('categories.update', $id) }}" enctype="multipart/form-data">
	...
	<div class="ti-modal-body grid grid-cols-12 gap-x-5">
		<div class="col-span-12">
			...
			<x-text-input type="text" name="name" value="{{ $category->name }}" required />
		</div>
        ...
        <div class="col-span-12 mt-2">
            ...
            <input type="file" name="image" class="dropify" data-default-file="{{ asset('/uploads/media/'.$category->image) }}">
        </div>
	</div>
