<x-app-layout>
	...
	<div class="main-content">
		<x-page-header title="Quotations" page="user" subpage="create" />
						...
						<div class="box-body">
								...
								<div class="lg:col-span-4 col-span-8">
									<div class="grid grid-cols-12 gap-y-3">
										<div class="col-span-12">
											<x-text-input class="text-xl font-bold" type="text" name="title" value="{{ get_business_option('quotaion_title', 'Invoice') }}" placeholder="{{ _lang('Invoice Title') }}" />
										</div>

										<div class="col-span-12">
											<x-text-input type="text" name="po_so_number" value="{{ old('po_so_number') }}" placeholder="{{ _lang('Sales Order No Or Any Other Reference') }}" />
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-span-12 space-y-3">
									<div class="grid grid-cols-12">
										...
										<div class="xl:col-span-5 col-span-12">
											<x-text-input type="text" class="flatpickr-input" id="date" name="quotation_date" value="{{ old('quotation_date') }}" placeholder="Select Date" />
										</div>
									</div>

									<div class="grid grid-cols-12">
										<x-input-label class="xl:col-span-2 col-span-12" value="{{ _lang('Expired Date') }}" />
										<div class="xl:col-span-5 col-span-12">
											<x-text-input type="text" class="flatpickr-input" id="date" name="expired_date" value="{{ old('expired_date') }}" placeholder="Select Date" />
										</div>
									</div>
								</div>
							...
							<div class="grid grid-cols-12">
								...
								<div class="col-span-12 mt-4">
									<x-primary-button type="submit" class="submit-btn">{{ _lang('Save Quotation') }}</x-primary-button>
								</div>
							</div>
						</div>
