    ...
    <div class="p-6 sm:p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            ...
            <div class="sm:text-right">
                ...
                <div class="mt-2 text-sm">
                    <p><span class="font-medium">Credit Purchase #:</span> {{ $bill->bill_no }}</p>
                    <p><span class="font-medium">Credit Purchase Date:</span> {{ $bill->purchase_date }}</p>
                    <p><span class="font-medium">Due Date:</span> {{ $bill->due_date }}</p>
                    @if($bill->po_so_number)
                    <p><span class="font-medium">PO/SO Number:</span> {{ $bill->po_so_number }}</p>
                    @endif
                    @if($bill->paid > 0)
                    <div class="mt-2">
                ...
                <div class="mt-4 sm:flex sm:justify-end">
                    ...
                    <div class="w-24 h-24 border-2 border-gray-300 border-dashed flex items-center justify-center text-xs text-gray-500">
                        {!! QrCode::size(200)->generate(route('bill_invoices.show_public_bill_invoice', $bill->short_code)) !!}
                    </div>
                </div>
            </div>
        </div>
